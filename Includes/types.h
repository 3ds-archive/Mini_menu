...
#define		ADD8(addr, value)		*(vu8*)(addr) += value;
#define		ADD16(addr, value)		*(vu16*)(addr) += value;
#define		ADD32(addr, value)		*(vu32*)(addr) += value;
#define		ADD64(addr, value)		*(vs64*)(addr) += value;

#define		SUB8(addr, value)		*(vu8*)(addr) -= value;
#define		SUB16(addr, value)		*(vu16*)(addr) -= value;
#define		SUB32(addr, value)		*(vu32*)(addr) -= value;
...
#define		get12c()	((READU32(0x33099f84)!=-1)*0x12c)
